package levitation.project.kanaksasak.e_pul.Adapter;
...
import levitation.project.kanaksasak.e_pul.Data.UploadInfo;
...
public class MarketAdapter extends RecyclerView.ViewHolder {
    ...
    public void bindMarket(final UploadInfo info, int position) {
        ...
        ImageView ImageView = (ImageView) mView.findViewById(R.id.img_produk);
        ImageView cart = (ImageView) mView.findViewById(R.id.cart);
        TextView nameTextView = (TextView) mView.findViewById(R.id.txt_price);

...
import levitation.project.kanaksasak.e_pul.Config;
...
public class PostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img_produk = (ImageView) rootView.findViewById(R.id.produk_img);
        btn_post = (Button) rootView.findViewById(R.id.btn_post);
        desc_txt = (EditText) rootView.findViewById(R.id.desc_txt);
        price_txt = (EditText) rootView.findViewById(R.id.price_txt);
